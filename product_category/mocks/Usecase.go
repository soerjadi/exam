...
func (_m *Usecase) Create(ctx context.Context, pc *models.ProductCategory) error {
...
func (_m *Usecase) DeleteByCategoryID(ctx context.Context, categoryID int64) error {
...
func (_m *Usecase) DeleteByProductID(ctx context.Context, productID int64) error {
...
func (_m *Usecase) GetByCategoryID(ctx context.Context, categoryID int64) ([]*models.ProductCategory, error) {
	ret := _m.Called(ctx, categoryID)
...
func (_m *Usecase) GetByProductID(ctx context.Context, productID int64) ([]*models.ProductCategory, error) {
	ret := _m.Called(ctx, productID)
