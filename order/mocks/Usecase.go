...
func (_m *Usecase) Create(ctx context.Context, _a1 *models.Order) error {
...
func (_m *Usecase) GetList(ctx context.Context, offset int64, limit int64) ([]*models.Order, int64, error) {
